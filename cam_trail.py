...
def all_gest():
    ...
    hands = mpHands.Hands(static_image_mode=False, min_detection_confidence=0.7, min_tracking_confidence=0.7,max_num_hands=1)
    ...
    # release the webcam and destroy all active windows
        ...
        if result.multi_hand_landmarks:
            ...
            for handslms in result.multi_hand_landmarks:
                ...
                mpDraw.draw_landmarks(frame, handslms, mpHands.HAND_CONNECTIONS, mp_drawing_styles.get_default_hand_landmarks_style(), mp_drawing_styles.get_default_hand_connections_style())
